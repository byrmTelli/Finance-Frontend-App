    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
            <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
                ...
                <button className='bg-[#F4CE14] w-[200px] rounded-md font-medium my-6 mx-auto  px-6 py-3 text-black'>Start Trial</button>
            </div>
            ...
            <div className="w-full shadow-xl flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
                ...
                <button className='text-[#F4CE14] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 bg-black'>Start Trial</button>
            </div>
